...
export default function RecentJobsPage() {
  ...
  if (!jobs.length) return <div style={{ padding: '2rem', textAlign: 'center' }}>Aucune offre récente.</div>;

  return (
    <div style={{ maxWidth: 820, margin: '0 auto', padding: '2.5rem 1.5rem' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 900, marginBottom: 8 }}>Offres récentes</h1>
